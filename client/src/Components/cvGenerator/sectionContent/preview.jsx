      ...
      <div id="profile">
        ...
        <div id="social-links">
          <a href={`mailto:${user.email}`}>
            <FontAwesomeIcon icon={faEnvelope} className="stroke-transparent" />
          </a>
          <a href={`tel:${user.phone}`}>
            <FontAwesomeIcon icon={faPhone} className="stroke-transparent" />
          </a>
          <a href={user.linkedin}>
            <FontAwesomeIcon icon={faLinkedin} className="stroke-transparent" />
          </a>
          <a href={user.github}>
            <FontAwesomeIcon icon={faGithub} className="stroke-transparent" />
          </a>
        </div>
        <hr width="100%" />
        <div id="about">
          ...
          {workHistory.map((work) => (
            <div key={work._id}>
              <p className="tags">
                ...
                <span>
                  {work.employmentType} |{" "}
                  {`${moment(work.startDate, "YYYY-MM").format("MMM YYYY")} - ${
                    !work.isCurrent
          ...
          {education.map((edu) => (
            <div key={edu._id}>
              <p className="tags">
                ...
                <span>
                  {" "}
                  {`${moment(edu.startDate, "YYYY-MM").format("MMM YYYY")} - ${
                    !edu.stillEnrolled
